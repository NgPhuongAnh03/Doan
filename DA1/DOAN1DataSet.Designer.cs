...
namespace DA1 {
    ...
    public partial class DOAN1DataSet : global::System.Data.DataSet {
        ...
        public partial class SanphamDataTable : global::System.Data.TypedTableBase<SanphamRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SanphamRow AddSanphamRow(string MaSP, string TenSP, string Size, int Soluong, double Giaban, string MaNCC) {
...
namespace DA1.DOAN1DataSetTableAdapters {
    ...
    public partial class SanphamTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sanpham] ([MaSP], [TenSP], [Size], [Soluong], [Giaban], [MaNCC" +
                "]) VALUES (@MaSP, @TenSP, @Size, @Soluong, @Giaban, @MaNCC);\r\nSELECT MaSP, TenSP" +
                ", Size, Soluong, Giaban, MaNCC FROM Sanpham WHERE (MaSP = @MaSP)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sanpham] SET [MaSP] = @MaSP, [TenSP] = @TenSP, [Size] = @Size, [Soluong] = @Soluong, [Giaban] = @Giaban, [MaNCC] = @MaNCC WHERE (([MaSP] = @Original_MaSP) AND ([TenSP] = @Original_TenSP) AND ([Size] = @Original_Size) AND ((@IsNull_Soluong = 1 AND [Soluong] IS NULL) OR ([Soluong] = @Original_Soluong)) AND ((@IsNull_Giaban = 1 AND [Giaban] IS NULL) OR ([Giaban] = @Original_Giaban)) AND ((@IsNull_MaNCC = 1 AND [MaNCC] IS NULL) OR ([MaNCC] = @Original_MaNCC)));
SELECT MaSP, TenSP, Size, Soluong, Giaban, MaNCC FROM Sanpham WHERE (MaSP = @MaSP)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSP, TenSP, Size, Soluong, Giaban, MaNCC FROM dbo.Sanpham";
        ...
        public virtual int Delete(string Original_MaSP, string Original_TenSP, string Original_Size, global::System.Nullable<int> Original_Soluong, global::System.Nullable<double> Original_Giaban, string Original_MaNCC) {
        ...
        public virtual int Insert(string MaSP, string TenSP, string Size, global::System.Nullable<int> Soluong, global::System.Nullable<double> Giaban, string MaNCC) {
            if ((MaSP == null)) {
        ...
        public virtual int Update(string MaSP, string TenSP, string Size, global::System.Nullable<int> Soluong, global::System.Nullable<double> Giaban, string MaNCC, string Original_MaSP, string Original_TenSP, string Original_Size, global::System.Nullable<int> Original_Soluong, global::System.Nullable<double> Original_Giaban, string Original_MaNCC) {
            if ((MaSP == null)) {
                throw new global::System.ArgumentNullException("MaSP");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenSP, string Size, global::System.Nullable<int> Soluong, global::System.Nullable<double> Giaban, string MaNCC, string Original_MaSP, string Original_TenSP, string Original_Size, global::System.Nullable<int> Original_Soluong, global::System.Nullable<double> Original_Giaban, string Original_MaNCC) {
            return this.Update(Original_MaSP, TenSP, Size, Soluong, Giaban, MaNCC, Original_MaSP, Original_TenSP, Original_Size, Original_Soluong, Original_Giaban, Original_MaNCC);
        }
    }
